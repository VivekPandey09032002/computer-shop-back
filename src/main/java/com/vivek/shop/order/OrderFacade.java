...
import com.vivek.shop.cart.CartFacade;
import com.vivek.shop.cart.CartItemQueryRepository;
...
import com.vivek.shop.product.ProductFacade;
...
class OrderFacade {
    ...
    OrderDto placeOrder(Customer customer) {
        ...
        var orderItems = cart.carts().stream().map(item -> {
